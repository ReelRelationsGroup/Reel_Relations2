  ...
  return (
    <div className="text-white mx-auto lg:w-1/3 sm:w-2/3 lg:text-xs sm:text-sm">
      ...
      <div className="mb-5">
        ...
        redux and tailwind to give the site a more modern look and feel.
      </div>
      ...
      <div className="mb-5">
        Our local app is slow but perfect, but for our live site we had to cut
        down the database due to renders hosting limitations, which means that
        not all actors will be found.
      </div>
    </div>
  );
};
